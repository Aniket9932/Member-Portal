import { Button, Flex, Text, useDisclosure,Modal,
  ModalOverlay,
  ModalContent,
  ModalHeader,
  ModalFooter,
  ModalBody,
  ModalCloseButton, Container } from '@chakra-ui/react'
  ...
  return (
    <div>
      <Flex align={'center'} justify='center' mt={7}>
        ...
        <Button onClick={ () => {getData(); onOpen()} }>Show Caregiver</Button>
